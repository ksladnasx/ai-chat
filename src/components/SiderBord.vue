...
onMounted(()=>{
 const user  = localStorage.getItem("userInfo")
  if(user){
    src.value = JSON.parse(user).avatarUrl
  }
})
// 跳转到个人信息
...
<template>
  <div class="sidebar">
    ...
    <div class="menu">
      ...
      <div class="menu-item" @click="navigateTo('/chat')" :class="{ active: route.path === '/chat' }">
    ...
    <div class="user-info">
      ...
      <div class="user-details">
        ...
        <div class="user-role">{{ userStore.$state.userInfo.sex }}</div>
      </div>
